...
class SignupPage extends StatefulWidget {
  final String? selectedRole; // Role passed from RoleSelectionPage
...
class _SignupPageState extends State<SignupPage> {
  ...
  void signUp() async {
    ...
    try {
      ...
      // Navigate immediately (no waiting for Firestore write)
      if (mounted) {
      ...
      // Save role locally in Hive (background)
      Hive.box('settings').put('role', widget.selectedRole ?? "user");

      // Save user data in Firestore (background)
